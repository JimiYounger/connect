...
export function VideoSearchModal({ isOpen, onClose, userPermissions: _userPermissions }: VideoSearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-sm z-50 md:flex md:items-center md:justify-center md:p-4">
      <div className="bg-gray-900 w-full h-full md:h-auto md:max-w-4xl md:max-h-[90vh] md:rounded-2xl overflow-hidden flex flex-col">
        {/* Mobile Header */}
